"""
Módulo para gestión de aplicaciones instaladas (REFACTORIZADO)
Corresponde a la opción 11 del menú

NOTA: Este módulo ha sido refactorizado a application/use_cases/manage_applications.py
...
from .manage_applications import ejecutar
